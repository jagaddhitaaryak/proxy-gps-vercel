...
module.exports = async (req, res) => {
    ...
    res.setHeader('Access-Control-Allow-Origin', 'https://NAMA-ANDA.github.io'); // <== GANTI INI
    ...
    // Browser mengirim ini secara otomatis sebelum request POST untuk mengecek izin CORS
    ...
    // --- LOGIKA INTI PROXY ---
    // Detail ini sekarang aman di sisi server dan tidak terlihat di admin.html
    ...
    try {
        ...
        if (!apiResponse.ok) {
            // Jika EasyGo error, kirimkan errornya
